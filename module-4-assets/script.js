...
// var formEl = document.querySelector("#task-form")
// // counter to assign a new ID to tasks made 
// var taskIdCounter = 0;
// // grabs on to the main tag in html this will be used for deleting task
// var pageContentEl = document.querySelector("#page-content")
...
// // function to create name and type of task 
// var createTaskEl = function(taskDataObj){
...
// // function to add the buttons for delete , edit and select to task
// var createTaskActions = function(taskId){
//   // create contianer for the new elemetns 
//   // use this variable to post on the page *******
//   var actionContainerEl = document.createElement("div");
//   actionContainerEl.className = "task-actions";

//   // create the edit button button
//   var editButtonEl = document.createElement("button");
//   editButtonEl.textContent = "Edit";
...
//     // need the task ID for removing the entire task
//     var taskId = targetEl.getAttribute("data-task-id");
//     deleteTask(taskId);
//   }
...
// // This deletes our task 
// var deleteTask = function(taskId){
//   // connects us to the li element above 
//   var taskSelected = document.querySelector(".task-item[data-task-id='" + taskId + "']");
//   taskSelected.remove();
...
//   // connect to update the form
//   document.querySelector("input[name='task-name']").value = taskName;
//   document.querySelector("select[name='task-type']").value = taskType; 

//   // changes the add task button to save task
//   document.querySelector("#save-task").textContent = "Save Task";
...
// // listener is used for the add task
// formEl.addEventListener("submit", taskFormHandler);
// // listener is used for the delete button
// pageContentEl.addEventListener("click", taskButtonHandler);
